...
utils.verifyChunk(utils.loadfileIn('Scripts/UI/RadioCommandDialogPanel/Config/Common/AWACS.lua', getfenv()))(7, {tanker = true, radar = true})    --added for JTAC mod  http://forums.eagle.ru/showpost.php?p=2599365&postcount=328
